      ...
      <div class="col-md-6">
        <div class="card">
          <div class="card-header">
            {props.device.name || <Text id="device.noNameLabel" />}{' '}
            {batteryLevel && (
          ...
          >
            ...
            <div class="dimmer-content">
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <Localizer>
                    <input
                      ...
                      class="form-control"
                      placeholder={<Text id="device.nameLabel" />}
                    />
                  </Localizer>
                </div>
                <div class="form-group">
                  <label>
                    <Text id="device.roomLabel" />
                  </label>
                ...
                <div class="form-group">
                  <label>
                    <Text id="device.featuresLabel" />
                  </label>
                  <DeviceFeatures features={props.device.features} />
                  <p class="mt-4">
                    {mostRecentValueAt ? (
                      <Text
                        id="device.mostRecentValueAt"
                        fields={{
                      ...
                      <Text id="device.noValueReceived" />
                    )}
                  </p>
                </div>
